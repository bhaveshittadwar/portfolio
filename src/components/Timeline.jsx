      ...
      {details.map((detail, index) => (
        ...
        >
          <div className="flex items-center">
            <div className="shadow-custom z-10 flex items-center justify-center w-6 h-6 bg-zinc-900 rounded-full ring-0 ring-white md:ring-8 dark:ring-gray-900 shrink-0">
              <svg
          ...
          <div className={`mt-3 ${index === details.length - 1 ? '' : 'md:pe-8 lg:pe-40'}`}>
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">{detail.company}</h3>
